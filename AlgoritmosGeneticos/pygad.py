...
#target_im = imageio.imread('C:/Users/alvar/Pictures/Screenshots/Captura de pantalla (12).png')
...
#target_im = scipy.misc.imread('LISA.png')

target_im = cv2.imread('LISA.png')
